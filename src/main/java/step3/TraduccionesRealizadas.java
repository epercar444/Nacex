...
public class TraduccionesRealizadas {
	...
	/**
	 * obtenerTraduccionesRealizadas: a partir de pasar por parámetro el nombre de los ficheros de los que queremos comparar sus propiedades,
	 * cargamos las propiedades de ambos, recorremos las propiedades del fichero origen y si este coincide con las propiedades del fichero idioma
	 ...
	 * @return una lista de propiedades que coincidan en ambos ficheros
	 */
